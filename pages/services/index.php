 ...
 *
 * This file draws the index; the same document holds the six detail pages, and
 * lib/services.php draws those. See the note at the top of that file for why
 * they are one document and not seven.
 *
...
<link rel="canonical" href="https://tech4time.bd/pages/services/">
...
<meta property="og:url" content="https://tech4time.bd/pages/services/">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "name": "Services", "item": "https://tech4time.bd/pages/services/" }
  ]
}
</script>
...
<!-- icon-sprite:end -->
<?= services_sprite(services_icons_used($data, null)) ?>
...
<?= services_nav_band($data) ?>
<?= services_blocks_band($data) ?>
<?= services_ossf_band($data) ?>
<?= services_cta($data['cta'], 'services-cta-heading', 'cta-band cta-band--base') ?>
</main>
