 ...
 * that one byte-identical to tools/templates/. The scroll-reveal markers are
 * emitted by the renderer, because tools/apply_reveals.py reports and skips
 * any page that builds part of itself with a loop.
 */
...
<?= sprite_block(services_icons_used($data, null)) ?>

<?php body_header('/pages/services/'); ?>
