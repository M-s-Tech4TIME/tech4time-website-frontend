...
<head>
<?php seo_head('/pages/services/hr-solutions/', $service['meta'], ['pages/service-detail.css?v=2'], $data['updated']); ?>
<?php seo_jsonld('/pages/services/hr-solutions/', $service['meta'], $data['updated']); ?>
...
<?php body_header('/pages/services/hr-solutions/'); ?>
...
<?php body_dock('/pages/services/hr-solutions/'); ?>
