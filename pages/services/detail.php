 ...
 * inject_icons.py, apply_reveals.py — still finds it. A SEVENTH service,
...
<?= sprite_block(services_icons_used($data, $service)) ?>

<?php body_header('/pages/services/' . $slug . '/'); ?>
...
<?php body_dock('/pages/services/' . $slug . '/'); ?>
