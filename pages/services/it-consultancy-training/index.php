...
<head>
<?php seo_head('/pages/services/it-consultancy-training/', $service['meta'], ['pages/service-detail.css?v=2'], $data['updated']); ?>
<?php seo_jsonld('/pages/services/it-consultancy-training/', $service['meta'], $data['updated']); ?>
...
<?php body_header('/pages/services/it-consultancy-training/'); ?>
...
<?php body_dock('/pages/services/it-consultancy-training/'); ?>
