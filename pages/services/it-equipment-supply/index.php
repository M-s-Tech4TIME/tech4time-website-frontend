...
<head>
<?php seo_head('/pages/services/it-equipment-supply/', $service['meta'], ['pages/service-detail.css?v=2'], $data['updated']); ?>
...
<?php body_header('/pages/services/it-equipment-supply/'); ?>
...
<?php body_dock('/pages/services/it-equipment-supply/'); ?>
