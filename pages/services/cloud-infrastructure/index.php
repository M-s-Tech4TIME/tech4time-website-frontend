...
<head>
<?php seo_head('/pages/services/cloud-infrastructure/', $service['meta'], ['pages/service-detail.css?v=2'], $data['updated']); ?>
<?php seo_jsonld('/pages/services/cloud-infrastructure/', $service['meta'], $data['updated']); ?>
...
<?php body_header('/pages/services/cloud-infrastructure/'); ?>
...
<?php body_dock('/pages/services/cloud-infrastructure/'); ?>
