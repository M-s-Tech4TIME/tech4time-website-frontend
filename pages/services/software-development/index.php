...
<head>
<?php seo_head('/pages/services/software-development/', $service['meta'], ['pages/service-detail.css?v=2'], $data['updated']); ?>
<?php seo_jsonld('/pages/services/software-development/', $service['meta'], $data['updated']); ?>
...
<?php body_header('/pages/services/software-development/'); ?>
...
<?php body_dock('/pages/services/software-development/'); ?>
