<?php
/**
 * Tech4TIME — the milestones page.
 *
 * PHP, and not HTML, because its content is edited at admin.tech4time.bd
 * and arrives here as content/milestones.json. Rendered on the server, on this
 ...
 *
 * TWO PAGES DRAW THIS ONE DOCUMENT. /pages/company-profile/ shows the most
 * recent MILESTONES_WINDOW years of the same timeline and links here for the
 * rest; this page shows all of it. The markup and the stylesheet are shared —
 * assets/css/pages/milestones.css — so the two cannot drift apart.
 *
...
<head>
<?php seo_head('/pages/milestones/', $data['meta'], ['pages/milestones.css'], $data['updated']); ?>
...
<body class="page">
<?php body_header('/pages/milestones/'); ?>
...
<div class="container page-hero__inner">
  ...
  <!-- ============================ The timeline ===========================
       THE WHOLE HISTORY, which is the only thing this page is for. The
       company profile shows the most recent MILESTONES_WINDOW years of the
       same list and links here; both read one document, so there is no second
       copy of anybody's history to keep in step.

       The markup is the company profile's, to the character, because the
       styling is one stylesheet — assets/css/pages/milestones.css — that both
       pages load. A timeline that looked different on its own page would be
       two designs, not one.

       tools/apply_reveals.py leaves this page alone: it builds itself with a
       loop, and the tool says so and stops rather than reading one <li> where
       a visitor will see forty. The markers below are therefore by hand, and
       they are the company profile's markers.
       ==================================================================== -->
<?php if (milestones_band_shown($data, 'timeline')): ?>
...
<?php if (trim((string)$data['timeline']['eyebrow']) !== ''): ?>
        <span class="section__eyebrow"><?= h($data['timeline']['eyebrow']) ?></span>
<?php endif; ?>
        <h2 class="section__title" id="milestones-heading"><?= h($data['timeline']['title']) ?></h2>
<?php if (trim((string)$data['timeline']['lead']) !== ''): ?>
<?php /* Printed unescaped, which is safe for exactly one reason: it
        ...
        <div class="section__lead"><?= $data['timeline']['lead'] ?></div>
<?php endif; ?>
      </div>

      <ol class="timeline" role="list">
<?php foreach (milestones_shown($data, 'timeline') as $row): ?>
...
<?php body_dock('/pages/milestones/'); ?>
