...
<head>
<?php seo_head('/pages/careers/', $data['meta'], ['pages/careers.css'], $data['updated']); ?>
<?php seo_jsonld('/pages/careers/', $data['meta'], $data['updated']); ?>
