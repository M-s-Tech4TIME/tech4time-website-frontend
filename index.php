 ...
 *
 * THIS FILE IS AT THE REPOSITORY ROOT, which is why five tools glob for
 * "index.php" beside their "*.html": propagate_shared, check_shared_markup,
 * inject_icons, audit_pages and apply_reveals. A root glob of "*.html" alone
 * stops seeing this page the moment it becomes PHP, and stops silently — the
 * page keeps rendering and simply goes stale.
 *
 * The header, footer and dock are emitted by lib/body.php from
 * content/chrome.json. This page has no hero circuit — there is no page-title
 * band on the home page — so nothing here is shared markup at all any more.
 * The Service ItemList below is generated, because it describes this page's
 * own cards.
 *
...
<head>
<?php seo_head('/', $data['meta'], ['pages/home.css?v=2'], $data['updated']); ?>
<?php seo_jsonld('/', $data['meta'], $data['updated']); ?>
